...
UNSUPERVISED LEARNING REPORT PYTHON SCRIPTS

1) My datasets are AP_Analytics.csv and Attractiveness_Analytics.csv, as can be seen in the main folder
2) Run the python scripts k-means_ap.py, k-means_ap_groundtruth.py, k-means_attractiveness.py, and k-means_attractiveness.py to produce k-means visualizations 
3) Then in the folder assignment 3 do the following:
