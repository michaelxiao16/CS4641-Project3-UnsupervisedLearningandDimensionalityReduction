...
def runEverything():
                        ...
                        for sizeLayer in sizeLayers:
                            for layerSlope in layerSlopes:
                                for maxIter in maxIters:
                                    for alg in algs:
                                        start = time.time()
                                        result = [perc,activation,solver,numLayer,sizeLayer,layerSlope,maxIter,alg]
                                        data = transform(data,alg)
    ...
    csvW.writerow(["Training %","Activation F","Solver","# Layers","Max Layer Size","Layer Slope","Max_Iter","alg","Training Error %","Validation Error %","Testing Error %","Total Error %","Diff in Error %","s"])
